...
func (c *confirmedNew) createStack(
	...
	if c.createsStack() {
		...
		return createStackWithRetry(ctx, sink, ws, b, args.prompt, c.stackName, root, args.yes, opts,
...
func (c *confirmedNew) resolveConfigDefaults(
	...
	return resolveTemplateDefaults(projectName, template.Config, c.commandLineConfig, nil, nil)
}
